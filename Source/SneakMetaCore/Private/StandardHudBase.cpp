...
void AStandardHudBase::BeginPlay()
{
	Super::BeginPlay();
...
void AStandardHudBase::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	ClearAllHandlers();
	Super::EndPlay(EndPlayReason);
}

void AStandardHudBase::UpdateWidgets()
{
	ClearAllHandlers();
